...
var itemForm = document.getElementsByClassName("usluga");
console.log(itemForm);
var akcija=document.getElementById("PrelazSaCenovnikaNaZakazivanje");
akcija.onclick=async function(){
  
  window.location.href = "./LoginKorisnik";
}

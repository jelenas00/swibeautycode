...
document.getElementById("namedropdown-togglefl3").innerHTML=`${vlasnik.ime}`;
document.getElementById("namedropdown-headerfl3").innerHTML=`${vlasnik.ime} ${vlasnik.prezime}`;

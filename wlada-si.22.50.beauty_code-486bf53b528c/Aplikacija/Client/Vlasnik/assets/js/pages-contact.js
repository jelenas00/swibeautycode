...
document.getElementById("namedropdown-toggleps").innerHTML=`${vlasnik.ime}`;
document.getElementById("namedropdown-headerps").innerHTML=`${vlasnik.ime} ${vlasnik.prezime}`;

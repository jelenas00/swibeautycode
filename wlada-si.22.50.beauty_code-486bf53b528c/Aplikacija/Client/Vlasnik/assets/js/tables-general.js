...
let api= new Api();
document.getElementById("namedropdown-togglet").innerHTML=`${vlasnik.ime}`;
document.getElementById("namedropdown-headert").innerHTML=`${vlasnik.ime} ${vlasnik.prezime}`;
var listaRadnika=[];
...
function showModal( data) {
    ...
    <div class="col-md-4">
                  ...
                  <select id="inputTip" class="form-select zaposliForma">
                    ...
                    <option value="Kozmetičar">Kozmetičar/ka</option>

...
document.getElementById("namedropdown-toggleus").innerHTML=`${vlasnik.ime}`;
document.getElementById("namedropdown-headerus").innerHTML=`${vlasnik.ime} ${vlasnik.prezime}`;
